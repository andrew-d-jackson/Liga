...
DataType VectorType::data_type() const { return DataType::Vector; }

bool VectorType::operator==(const GenericType &other) const {
...
llvm::Type *VectorType::llvm_type() const {
...
GenericValue VectorType::create(llvm::Value *val) const {
  return GenericValue(std::make_shared<VectorType>(sub_type), val);
}

GenericValue VectorType::copy(Enviroment &env, llvm::IRBuilder<> &builder,
...
void VectorType::for_each_element(Enviroment &env, llvm::IRBuilder<> &builder,
                                  GenericValue vec,
...
llvm::Function *VectorType::destructor(Enviroment &env,
...
void VectorType::destroy(Enviroment &env, llvm::IRBuilder<> &builder,
                         GenericValue val) const {
